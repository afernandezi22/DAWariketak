...
INSERT INTO `denda` (`kodea`, `izena`, `tlf`) VALUES
(1, 'CENTRAL', '600100100'),
(2, 'SUCURSAL1', '600100200'),
(3, 'SUCURSAL2', NULL);

INSERT INTO `familia` (`kodea`, `izena`) VALUES
...
INSERT INTO `produktu` (`kodea`, `izena`, `izen_laburra`, `deskribapena`, `prezioa`, `familia`) VALUES
...
INSERT INTO `stock` (`produktu`, `denda`, `kopurua`) VALUES
('3DSNG', 1, 2),
('3DSNG', 2, 1),
('ACERAX3950', 1, 1),
('ARCLPMP32GBN', 2, 1),
